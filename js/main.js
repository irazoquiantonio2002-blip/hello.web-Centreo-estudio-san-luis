/* ============================================================
   CENTRO DE ESTUDIOS SAN LUIS — main.js
   ============================================================ */
(function () {
  'use strict';
  ...
  if (marqueeInner) {
    const items = [
      'Regularización Académica', 'Cursos de Verano', 'Preparación UNAM',
      'Preparación IPN', 'Inglés para Niños', 'Curso de Invierno',
      'Acompañamiento Psicológico', 'Cuautepec, CDMX', 'Más de 12 Años de Experiencia',
      'Atención Personalizada', 'Exámenes de Simulación', 'De 4 a 17 Años'
    ];
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const phone = '525516394271';
      const text  = encodeURIComponent(
        `Hola Centro de Estudios San Luis 🎓\n\nSoy *${name}*.\nMe interesa: *${interest}*.\n\n${message}`
      );
